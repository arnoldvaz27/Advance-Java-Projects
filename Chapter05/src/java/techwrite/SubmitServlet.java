...
public class SubmitServlet extends HttpServlet
{
    ...
    throws ServletException, IOException {
        ...
        String on="checked";
     String active=request.getParameter("c1");
...
ck2.setMaxAge(age);
 ...
 RequestDispatcher dispatch = request.getRequestDispatcher("WelcomeEmployeeServlet");
...
RequestDispatcher dispatch = request.getRequestDispatcher("ErrorServlet");
	     dispatch.forward(request, response);
        }
    }
