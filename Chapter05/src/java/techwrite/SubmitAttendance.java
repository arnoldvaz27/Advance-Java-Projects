 ...
 * @author Karuna.Sadh
 */
@WebServlet(name="SubmitAttendance", urlPatterns={"/SubmitAttendance"})
public class SubmitAttendance extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
          ...
          out.println("<html>");
          out.println("<head>");
          out.println("<title>SubmitAttendance Page</title>");
           out.println("</head>");
           out.println("<body>");
          ...
          out.println("<td bgcolor='maroon' align='center'>");
           ...
           out.println("</tr>");
           out.println("</table>");
          out.println("<font style='font-family: 'Arial Rounded MT Bold;' size='+2' color='blue'>You have successfully marked Attendance!!");
            out.println("</body>");
            out.println("</html>");
