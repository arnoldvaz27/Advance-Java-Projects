...
protected void processRequest(HttpServletRequest request, HttpServletResponse response)
 ...
 out.println("<html>");
           ...
           out.println("</table>");
            ...
            out.println("<tr><td bordercolor='white'>Login Id:<input type='text' name='lid'value='"+Userid+"'>");
     out.println("<td bordercolor='white'>Password:<input type='password' name='pwd'value='"+Password+"'>");
     out.println("<td bordercolor='white'><input type='Submit'value='GO'>");
   out.println("<td bordercolor='white'><input type='checkbox' name='c1' value='checked'/>Remember Me");
            out.println("</table>");
                out.println("<br/>");
                    out.println("<br/>");
