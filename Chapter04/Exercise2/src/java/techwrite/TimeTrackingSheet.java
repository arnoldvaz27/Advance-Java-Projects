...
public class TimeTrackingSheet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
           out.println("<html>");
            out.println("<head>");
            out.println("<title>TimeTrackSheet Page</title>");
            out.println("</head>");
            out.println("<body>");
           ...
           out.println("<font style='font-family: 'Arial Rounded MT Bold', Gadget, sans-serif;' size='+4' color='#FFE4B5'>HighTech Inc.</font>");
            out.println("</td>");
