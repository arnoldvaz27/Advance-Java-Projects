 ...
 * @author karuna.sadh
 */
@WebServlet(name="TimeErrorServlet", urlPatterns={"/TimeErrorServlet"})
public class TimeErrorServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
          ...
          out.println("</tr>");
          out.println("</table>");
          out.println("<font style='font-family: 'Arial Rounded MT Bold;' size='+2' color='red'>Sorry!! You can log time in TTS only on day end!!");
        } finally { 
            out.close();
        }
    } 
