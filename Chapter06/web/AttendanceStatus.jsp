...
<td bordercolor='white'><input type='text' value='<% out.print(d); %>'>
<tr><td bordercolor='white'>Attendance Status:
<td bordercolor='white'><input type='Radio' value='fullday' name='r3' CHECKED>Full day
<td bordercolor='white'><input type='Radio'value='halfday' name='r3'>Half day
<td bordercolor='white'><input type='Radio'value='leave' name='r3'>Leave
